...
/*
    ...
    braces. You typically find local classes defined in the body of a method.
    Refer from: https://docs.oracle.com/javase/tutorial/java/javaOO/localclasses.html
 */
public class LocalClassExample {
    ...
    public static void validatePhoneNumber(
        ...
        /*
            Note:
            1. A local class has access to the members of its enclosing class. In the previous example, the PhoneNumber
            ...
            3. Local classes are similar to inner classes because they cannot define or declare any static members.
         */
        class PhoneNumber {
